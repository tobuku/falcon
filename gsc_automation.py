...
PROPERTY_URL = "sc-domain:falconrydirectory.com"
...
def report_pages(service, days, limit):
    ...
    print("-" * 82)
    for i, row in enumerate(rows, 1):
        page = row["keys"][0].replace("https://falconrydirectory.com", "")[:49] or "/"
...
def main():
    parser = argparse.ArgumentParser(description="GSC Automation - FalconryDirectory.com")
